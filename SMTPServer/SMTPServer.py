__author__ = "Christopher Windmill, Brad Solomon, Konrad Niedzwiedzki"
...
class NWSThreadedServer(object):
    ...
    def _configureServer(self):
        self._listening_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM, 0)
